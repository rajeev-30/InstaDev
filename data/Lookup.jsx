...
export default {
    ...
    SIGNIN_SUBHEADING: 'To use InstaDev you must log into an existing account or create one.',
    SIGNIn_AGREEMENT_TEXT: 'By using InstaDev, you agree to the collection of usage data for analytics.',
